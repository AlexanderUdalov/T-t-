...
namespace Hellmade.Sound
{
    ...
    public class EazySoundManager : MonoBehaviour
    {
        ...
        /// <param name="clip">The audio clip to play</param>
        /// <returns>The ID of the created Audio object</returns>
        public static int PlayMusicDelayed(AudioClip clip,float delay)
        {
            return PlayAudioDelayed(Audio.AudioType.Music, clip, 1f, false, false, 1f, 1f, -1f, null, delay);
        }
        ...
        private static int PlayAudioDelayed(Audio.AudioType audioType, AudioClip clip, float volume, bool loop, bool persist, float fadeInSeconds, float fadeOutSeconds, float currentMusicfadeOutSeconds, Transform sourceTransform, float delay)
        {
            int audioID = PrepareAudio(audioType, clip, volume, loop, persist, fadeInSeconds, fadeOutSeconds, currentMusicfadeOutSeconds, sourceTransform);
            ...
            GetAudio(audioType, false, audioID).PlayDelayed(delay);
